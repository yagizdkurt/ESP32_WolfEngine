...
// THE NOTE
// ======================
struct SoundClip { uint16_t frequency; uint16_t duration; };
...
enum Note_t : uint16_t {
    ...
    // Octave 1
    C1  = 33,  CS1 = 35,  D1  = 37,  DS1 = 39,  E1  = 41,
    F1  = 44,  FS1 = 46,  G1  = 49,  GS1 = 52,  A1  = 55,
    AS1 = 58,  B1  = 62,

    // Octave 2
    C2  = 65,  CS2 = 69,  D2  = 73,  DS2 = 78,  E2  = 82,
    F2  = 87,  FS2 = 93,  G2  = 98,  GS2 = 104, A2  = 110,
    AS2 = 117, B2  = 123,
    ...
    // Octave 7
    C7  = 2093, CS7 = 2217, D7  = 2349, DS7 = 2489, E7  = 2637,
